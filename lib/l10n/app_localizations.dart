...
abstract class AppLocalizations {
  ...
  /// No description provided for @no_sales_orders.
  ///
  /// In fr, this message translates to:
  /// **'Aucune commande de vente'**
  String get no_sales_orders;

  /// No description provided for @create_first_sale_order.
  ///
  /// In fr, this message translates to:
  /// **'Créez votre première commande de vente'**
  String get create_first_sale_order;
  ...
  /// No description provided for @sales_person.
  ///
  /// In fr, this message translates to:
  /// **'Commercial'**
